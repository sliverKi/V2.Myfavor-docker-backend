    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(2, '이름은 2자 이상이어야 합니다.')])),
                ('nickname', models.CharField(max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(3, '닉네임은 3자 이상이어야 합니다.')])),
                ...
                ('selected_time', models.DateTimeField(default=datetime.datetime.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ScheduleTitle', models.CharField(default='', max_length=100)),
                ('location', models.CharField(default='', max_length=100)),
                ('when', models.DateTimeField(default=datetime.datetime.now)),
                ('is_enroll', models.BooleanField(default=False)),
                ('ScheduleType', models.ForeignKey(blank=True, max_length=150, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='report', to='boards.board')),
